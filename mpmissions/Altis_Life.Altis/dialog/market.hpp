...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>BORSA</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Alisveris</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "Uzun vadede"; //--- ToDo: Localize;
		...
		{
			idc = 1003;
			text = "Kisa vadede"; //--- ToDo: Localize;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
			y = 13.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 13 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
