    ...
    class cop {
        ...
        vests[] = {
          ...
          //  { "V_TacVest_gen_F", "", 1000, "call life_coplevel >= 1" }, //Apex DLC
            { "V_PlateCarrierSpec_blk", "", 1500, "call life_coplevel >= 2" }
        };
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_FieldPack_cbr", "", 500, "" },
    ...
    class reb {
        ...
        uniforms[] = {
            { "NONE", $STR_C_Remove_uniforms, 0, "" },
             ...
             { "U_O_OfficerUniform_ocamo", "", 5000, "" },
             { "U_OrestesBody", "", 5000, "" },
            // { "U_BG_leader", "", 5000, "" },
             { "U_BG_Guerilla3_1", "", 5000, "" },
           //  { "U_BG_Guerilla_6_1", "", 5000, "" },

            // { "U_B_FullGhillie_sard", "", 10000, "" },
           //  { "U_O_FullGhillie_sard", "", 10000, "" },
             { "U_I_GhillieSuit", "", 10000, "" },
             { "U_O_GhillieSuit", "", 10000, "" },
             { "U_B_GhillieSuit", "", 10000, "" },

             { "U_I_FullGhillie_sard", "", 10000, "" }
       ...
       /*     { "U_IG_Guerilla1_1", "", 5000, "" },
        ...
        headgear[] = {
            ...
            { "H_HelmetSpecB_snakeskin", "", 3000, "" }
           // { "H_HelmetLeader0_ocamo", "", 3500, "" }
            //{ "H_HelmetO_ViperSP_hex_F", "", 2500, "" }            
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "" },
            { "G_Shades_Black", "", 20, "" },
        ...
        vests[] = {
            ...
            //{ "V_PlateCarrier2_blk", "", 20500, "" },
            { "V_PlateCarrierIAGL_dgtl", "", 30000, "" }
        };
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_OutdoorPack_blk", "", 500, "" },
