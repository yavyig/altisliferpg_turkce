...
/* System Settings */
    ...
    noatm_timer = 0; //Time in minutes that players cannot deposit money after selling stolen gold.
    ...
    total_maxWeight = 400; //Static variable for the maximum weight allowed without having a backpack
    ...
    escapeMenu_timer = 3; //Time required to pass before you can click the abort button in the escape menu.
    escapeMenu_displayExtras = true; //Display the players UID & serverName specified below in the escape menu.
    escapeMenu_displayText = "MAVI RPG"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    service_chopper = 0; //Cost to service chopper at chopper service station(Repair/Refuel).
    ...
    gang_price = 7500; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    gang_upgradeBase = 1000; //The base cost for purchasing additional slots in a gang
    ...
    jail_forceWalk = true;
    jail_timeMultiplier = 4; //Put in minutes how long you want your victim in jail.
    ...
    paycheck_cop = 150000; //Payment for cops
    paycheck_civ = 25000; //Payment for civillians
    ...
    chopShop_vehicles[] = { "Car", "Air","true","True"}; //Vehicles that can be chopped. (Can add: "Ship" and possibly more -> look at the BI wiki...)
