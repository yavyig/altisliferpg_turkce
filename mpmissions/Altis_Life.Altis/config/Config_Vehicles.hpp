    ...
    */
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "B_T_LSV_01_unarmed_CTRG_F", "" } //Apex DLC
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "C_SUV_01_F", "" },
            { "C_Hatchback_01_sport_F", "call life_coplevel >= 0" },
            { "B_MRAP_01_F", "call life_coplevel >= 0" },
            { "B_MRAP_01_hmg_F", "call life_coplevel >= 0" },
            { "B_MBT_01_mlrs_F", "call life_coplevel >= 0" },
            { "B_T_MBT_01_cannon_F", "call life_coplevel >= 0" }
    ...
    class cop_air {
        ...
        vehicles[] = {
          ...
          //  { "B_UAV_05_F", "" }, //unable to get in      
           // { "B_UAV_02_F", "" },  //unable to get independent
