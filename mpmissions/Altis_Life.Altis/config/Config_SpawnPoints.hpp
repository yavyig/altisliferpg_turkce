...
class CfgSpawnPoints {
    ...
    class Altis {
        class Civilian {
            ...
            class Airport {
            displayName = "Sivil Havaalani";
            spawnMarker = "spawn_airport";
            icon = "\a3\ui_f\data\map\MapControl\watertower_ca.paa";
            conditions = "";
            };
