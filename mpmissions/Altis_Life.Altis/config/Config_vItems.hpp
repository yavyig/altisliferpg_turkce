...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "defibrillator" };
    };
    ...
    class rebel {
        ...
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge", "defibrillator" };
    };
...
class VirtualItems {
    ...
    class blastingcharge {
        ...
        displayName = "STR_Item_BCharge";//"C4 Patlayici";
        weight = 15;
        buyPrice = 35000;
        sellPrice = 10000;
        illegal = true;
