...
switch(true) do
{
	...
	{
		[0,format["Son Dakika: Uyusturucu Fiyatlarinda Artis Gozlemlendi."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Islenmis Petrolun Fiyati Artti."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Cimento-Demir-Cam Fiyatlari Artti."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Kulce Altin Fiyatlarinda Ciddi Dusus Gozlemlendi."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Kulce Altin - Bakir Fiyatlari Artti."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Kulce Altin Fiyati Artti."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	...
	{
		[0,format["Son Dakika: Uyusturucu Fiyatlari Azaldi."]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
