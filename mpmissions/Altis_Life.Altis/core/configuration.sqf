...
life_safezones = ["safe_kavala","safe_one","safe_two","safe_three","safe_four","safe_five","safe_six"]; // Replace "marker#" with your safezone marker names(variable names in editor). Can have infinite number of zones, make sure you serperate each zone with a comma(,) and enclose with quotation marks("") like I have shown with the examples.
